...
namespace MqttDeviceSimulator.Authentication;

/// <summary>
/// Client for device authentication via HTTP/REST
/// Simulates JWT token acquisition and refresh for MQTT connections
/// </summary>
public class MqttAuthClient
{
    ...
    public MqttAuthClient(string authServerUrl, bool useAuthentication = true)
    {
